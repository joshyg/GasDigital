    ...
    */
    ...
    _togglePlayPause() {
        ...
        if ( this.props.onTogglePlayback ) {
          this.props.onTogglePlayback( state.paused );
        }
    }
    ...
    */
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../node_modules/react-native-video-controls/./assets/img/top-vignette.png' ) }
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../../node_modules/react-native-video-controls/./assets/img/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../../node_modules/react-native-video-controls/./assets/img/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../../node_modules/react-native-video-controls/./assets/img/shrink.png' ) : require( '../../node_modules/react-native-video-controls/./assets/img/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../node_modules/react-native-video-controls/./assets/img/bottom-vignette.png' ) }
                    style={[ styles.controls.column ]}
                    imageStyle={[ styles.controls.vignette ]}>
                    { seekbarControl }
                    <View style={[
    ...
    renderPlayPause() {
        ...
        let source = this.state.paused === true ? require( '../../node_modules/react-native-video-controls/./assets/img/play.png' ) : require( '../../node_modules/react-native-video-controls/./assets/img/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../../node_modules/react-native-video-controls/./assets/img/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../../node_modules/react-native-video-controls/./assets/img/error-icon.png' ) } style={ styles.error.icon } />
