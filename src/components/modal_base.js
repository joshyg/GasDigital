...
import {View, Text, Image, StyleSheet, TouchableHighlight, Modal, Dimensions} from 'react-native';
   ...
   return (
       ...
       >
           <View style={transparent ? {} : styles.container}>
               { isOpen && <Body type={type} data={data} close={() => toggleModal(false)} toggleModal={toggleModal} navigation={navigation}/> }
           </View>
       </Modal>
   );
}
