...
import {View, Text, Image, TouchableHighlight, StyleSheet, Dimensions, WebView, Linking} from 'react-native';
        ...
        return (
            <View style={styles.container}>
                <View style={styles.control}>
                    <TouchableHighlight style={{marginLeft: 10}} onPress={onClose} underlayColor={'transparent'}>
