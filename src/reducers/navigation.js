...
export const AppNavigator = StackNavigator(RouteConfig,{initialRouteName:'app',headerMode:'none'});
const initialNavState = AppNavigator.router.getStateForAction(AppNavigator.router.getActionForPathAndParams('app'));
const initialState = {
    ...initialNavState,
    scene: {},
...
export default reducer = (state = initialState, action) => {
    ...
    case NAVIGATE_TO:
        ...
        return AppNavigator.router.getStateForAction( NavigationActions.navigate({routeName:action.payload.scene,params:action.payload.data}),
            {   ...nextState,
    ...
    case NAVIGATE_RESET_TO:
        ...
        tempState = AppNavigator.router.getStateForAction(NavigationActions.back({key: state.routes[1].key}),nextState);
        return AppNavigator.router.getStateForAction( NavigationActions.navigate({routeName:action.payload}), tempState );
